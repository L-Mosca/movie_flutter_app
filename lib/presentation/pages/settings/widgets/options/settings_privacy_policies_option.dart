...
class SettingsPrivacyPoliciesOption extends StatelessWidget {
  const SettingsPrivacyPoliciesOption({super.key, required this.onPressed});
  ...
  Widget _title(BuildContext context) {
    return Expanded(
      child: BaseText(
        text: context.strings.privacyPolicies,
